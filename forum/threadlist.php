    ...
    if(isset($_SESSION['loggedin']) == true ){
        ...
        <form action='. $_SERVER["REQUEST_URI"].' method="POST">
            <div class="form-group">
                ...
                <small id="emailHelp" class="form-text text-muted">Keep your title as short and brief as
                    possible.</small>
            </div>
            <div class="form-group">
        ...
        echo '
        <div class="container lead">You are not logged in.Log in to post comments and questions.</div>';
